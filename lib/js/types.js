...
(function (ObjectName) {
     ...
     * 不存储、不计数
     */
    ObjectName["CustomStatus"] = "Custom:Status";
    /**
     * 自定义消息：通知消息
     * 不存储、不计数
     */
    ObjectName["CustomNotification"] = "Custom:Notification";
    /**
     * 文本消息
     */
...
(function (ConnectionStatusAndroid) {
    ...
    ConnectionStatusAndroid[ConnectionStatusAndroid["USER_BLOCKED"] = 6] = "USER_BLOCKED";
    ConnectionStatusAndroid[ConnectionStatusAndroid["SIGN_OUT"] = 12] = "SIGN_OUT";
    ConnectionStatusAndroid[ConnectionStatusAndroid["SUSPEND"] = 13] = "SUSPEND";
    ConnectionStatusAndroid[ConnectionStatusAndroid["TIMEOUT"] = 14] = "TIMEOUT";
